...
function TodayDetails({ data }) {
	return (
		<>
			...
			<section className='col-span-1 md:col-span-2 lg:col-span-8 row-span-4 md:row-span-2 lg:row-span-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-8 grid-rows-4 md:grid-rows-2 lg:grid-rows-2 xl:grid-rows-1 gap-4'>
